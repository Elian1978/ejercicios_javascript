...
// Appi que covierte texto en voz

/* console.log(window);
console.log(document);

let texto = "Donde esta tu padre?";
...
*/
/* **********DOM: Atributos y Data-Attributes del HTML********** */
...
console.log($linkDOM.dataset.description);
$linkDOM.dataset.description = "Suscríbete a un canal y comparte";
console.log($linkDOM.dataset.description);
...
*/
/* **********     Curso JavaScript: 72. DOM: Manejadores de Eventos - Curso JavaScript: 73. DOM: Eventos con Parámetros y Remover Eventos -  ********** */
/*
...
$linkEventos.addEventListener("click", (e) => {
  alert("Hola soy tu amigo... Elian Rojas Rojas");
  e.preventDefault();
  e.stopPropagation();
}); */
/*
...
$btnAbrir.addEventListener(
  "click",
  (e) => (ventana = window.open("https://rojas.com"))
);
